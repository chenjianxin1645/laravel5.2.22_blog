        ...
        <form action="{{url('admin/article/store')}}" method="post">
            ...
            <table class="add_tab">
                    ...
                    <td>
                        <select name="cate_id" required>
                            @foreach($categorys as $category )
                                <option value="{{$category->id}}" @if(old('cate_id')==$category->id) selected @endif>
                                    {{$category->_name}}
                                </option>
                            @endforeach
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="editor" size="50" required value="{{old('editor')}}">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>文章关键字：</th>
                    <td>
                        <input type="text" class="lg" name="tags" value="{{old('tags')}}">
                    </td>
                </tr>
                <tr>
                    <th>缩略图：</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="" alt="" title="取消上传" id="cancel_art_thumb_img" style="max-width: 350px; max-height:100px;">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <script id="editor" name="content" type="text/plain" style="width:860px;height:400px;"></script>
                    </td>
                </tr>
                <tr>
                    <th></th>
        ...
        $(function () {
            ...
            $('#file_upload').uploadify({
                ...
                'onUploadSuccess': function (file, data, response) {
                    ...
                    var base = "{{asset('')}}";
                    $('#art_thumb_img').attr('src', base+data);
//                    $('#art_thumb_img').attr('path', data);
